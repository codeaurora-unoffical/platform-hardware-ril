...
*/
    ...
    {RIL_UNSOL_VOICE_RADIO_TECH_CHANGED, responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_DATA_RADIO_TECH_CHANGED, responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED, responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_CDMA_SUBSCRIPTION_SOURCE_CHANGED, responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_CDMA_PRL_CHANGED, responseVoid, WAKE_PARTIAL},
