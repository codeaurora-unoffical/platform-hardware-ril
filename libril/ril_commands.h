...
*/
    ...
    {RIL_REQUEST_REGISTRATION_STATE, dispatchVoid, responseRegState},
    {RIL_REQUEST_DATA_REGISTRATION_STATE, dispatchVoid, responseRegState},
    ...
    {RIL_REQUEST_GET_DATA_SUBSCRIPTION_SOURCE, dispatchVoid, responseDataSubscription},
